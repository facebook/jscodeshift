...
This document provides a detailed overview of each node type used in `jscodeshift`. Each node type includes a brief description and its definition as mapped to `ast-types`.
